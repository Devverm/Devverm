# Hi there, I'm Dev Verma 👨‍💻

**Data Analyst | Data Scientist**  
B.Tech | Vindhya Institute of Technology and Science | devpratap898291@gmail.com | Satna, MP



## 🚀 About Me
- 🎓 Recent **B.Tech graduate** mastering **EDA, ML clustering, Power BI dashboards**
- 💻 Tools: **Python (Pandas/NumPy), SQL joins, Power BI, Streamlit**
- 🌱 Learning: OpenCV, LangChain/RAG, advanced feature engineering
- 🎯 Seeking **entry-level data roles** – Kaggle competitor & project builder
- ⚡ Fun fact: Turn gaming strategies into data insights!
...
|---------|-------------|------------|------|
| Amazon Prime TV Shows and Movies | Analyzed genre distribution, regional availability, and content growth trends | Tools: Python, Pandas, NumPy, Matplotlib, Seaborn | [Repo](https://github.com/Devverm/Amazon-prime-video) |
| Airbnb Listings, Pricing & Host Behavior Analysis | Evaluated the percentage share of property types and room types to understand market composition | Power BI, Excel | [Repo](https://github.com/Devverm/Airbnb-Listings-Data-of-Chicago-and-New-Orleans-Dashboard) |
| Netflix | Analyzed regional content availability and format trends | Python, Pandas, NumPy, Matplotlib, Seaborn, Scikit-learn, Jupyter Notebook | [Repo](https://github.com/Devverm/Unsupervised-ML---Netflix-Movies-and-TV-Shows-Clustering) |
...
[![Email](mailto:your-email@gmail.com)](mailto:your-email@gmail.com)
[![Portfolio](https://img.shields.io/badge/Portfolio-Website-6366f1)](your-github.io)
